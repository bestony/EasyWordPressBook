...
![enter image description here](http://images.gitbook.cn/a754f450-6ace-11e8-be8f-7dfa349ed714)
...
<img src="http://images.gitbook.cn/ad4b4a80-6ace-11e8-95b2-5d9502ef3f23"  width = "60%" />
...
![enter image description here](http://images.gitbook.cn/b251e980-6ace-11e8-95b2-5d9502ef3f23)
...
![enter image description here](http://images.gitbook.cn/b6b347d0-6ace-11e8-b510-ebe41f970f61)
...
<img src="http://images.gitbook.cn/bc9c7ea0-6ace-11e8-95b2-5d9502ef3f23"  width = "60%" />

发布内容后，打开浏览器，[输入网址](http://yourdomain/wp-mail.php)，将 yourdomain 替换为你自己的域名），来触发 WordPress 去拉取邮件。

<img src="http://images.gitbook.cn/01af99a0-6acf-11e8-be8f-7dfa349ed714"  width = "70%" />

访问完成后，稍等2分钟，然后回到站点的首页、刷新，就可以看到我们通过邮件发布的内容了，再根据我们的需要编辑内容，发布即可。

![enter image description here](http://images.gitbook.cn/06293ae0-6acf-11e8-95b2-5d9502ef3f23)
...
![enter image description here](http://images.gitbook.cn/0b110740-6acf-11e8-b510-ebe41f970f61)
...
![enter image description here](http://images.gitbook.cn/0fb5fe40-6acf-11e8-b784-4fdd1e8c8060)

在设置页面中的 「Mailserver」 部分设置收件邮箱的地址（邮箱注册和配置的部分参考使用「通过电子邮件发布」功能发布文章中的第一小节，准备邮箱部分。）

<img src="http://images.gitbook.cn/15985740-6acf-11e8-b510-ebe41f970f61"  width = "80%" />
...
<img src="http://images.gitbook.cn/1bbdfad0-6acf-11e8-b510-ebe41f970f61"  width = "80%" />

如果设置错误，则会提醒你报错，比如下面这样的，便是账号密码不匹配。

![enter image description here](http://images.gitbook.cn/5ec34470-6acf-11e8-be8f-7dfa349ed714)

除了邮箱账号密码的设置以外，还有一个很重要的设置便是自动检查频次的设置，在下方的「Check for mail every」部分可以设置检查邮箱的频次，默认是 30 分钟一次，可以根据你的需要，调整检查的频次。

![enter image description here](http://images.gitbook.cn/6dd377f0-6acf-11e8-b784-4fdd1e8c8060)

此外，建议你设置一下 「 Message 」 中的 **Perferred Text Type**，这个项目用于指定默认的邮件类型，默认值是 Text，但是国内的邮件系统大多都是默认 HTML，所以可以也设置为“默认 HTML”。

![enter image description here](http://images.gitbook.cn/7ab92a50-6acf-11e8-95b2-5d9502ef3f23)
...
![enter image description here](http://images.gitbook.cn/88ae9f00-6acf-11e8-b510-ebe41f970f61)

我们可以看到，WordPress 自动的识别出我们通过邮件设置的格式等。

<img src="http://images.gitbook.cn/94d34b50-6acf-11e8-be8f-7dfa349ed714"  width = "80%" />
...
<img src="http://images.gitbook.cn/a1136ee0-6acf-11e8-be8f-7dfa349ed714"  width = "50%" />

发布后的效果如下：

![enter image description here](http://images.gitbook.cn/af635fa0-6acf-11e8-95b2-5d9502ef3f23)
